...
public class RewardsService : IRewardsService
{
    ...
    private Task CalculateLocationRewards(User user, ConcurrentBag<UserReward> newUserRewards, IEnumerable<Attraction> visitedAttractions, VisitedLocation visitedLocation)
    {
